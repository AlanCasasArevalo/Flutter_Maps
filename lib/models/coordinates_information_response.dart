...
//
//     final coordinatesInformationResponse = coordinatesInformationResponseFromJson(jsonString);

import 'dart:convert';

CoordinatesInformationResponse coordinatesInformationResponseFromJson(String str) => CoordinatesInformationResponse.fromJson(json.decode(str));

String coordinatesInformationResponseToJson(CoordinatesInformationResponse data) => json.encode(data.toJson());

class CoordinatesInformationResponse {
  CoordinatesInformationResponse({
    this.type,
    this.query,
    this.features,
    this.attribution,
  ...
  factory CoordinatesInformationResponse.fromJson(Map<String, dynamic> json) => CoordinatesInformationResponse(
    type: json["type"],
